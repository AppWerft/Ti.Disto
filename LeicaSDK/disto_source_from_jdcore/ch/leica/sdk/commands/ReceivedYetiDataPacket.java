...
public class ReceivedYetiDataPacket
  extends ReceivedDataPacket
{
  ...
  public YetiQuaternion getQuaternion()
    throws WrongDataException
  {
    if (d != null) {
      return d;
  ...
  public YetiMagnetometer getMagnetometer()
    throws WrongDataException
  {
    if (f != null) {
      return f;
  ...
  public YetiDistocomData getDistocom()
    throws WrongDataException
  {
    if (g != null) {
      return g;
  ...
  public class YetiDistocomData
  {
    ...
    {
      Logs.log(Logs.LogTypes.debug, "Distocom data Received: " + paramString);
      g = paramString;
  ...
  public class YetiMagnetometer
  {
    ...
    {
      Logs.log(Logs.LogTypes.debug, " magnetometer_X: " + a + " magnetometer_Y: " + b + " magnetometer_Z: " + c + " timestampAndFlags: " + d);
    }
  ...
  public class YetiAccelerationAndRotation
  {
    ...
    {
      Logs.log(Logs.LogTypes.debug, " rotationSensitivity: " + s + " acceleration_X: " + k + " acceleration_Y: " + l + " acceleration_Z: " + m + " accSensitivity: " + n + " rotation_X: " + o + " rotation_Y: " + p + " rotation_Z: " + q + " timestampAndFlags: " + r);
    }
  ...
  public class YetiQuaternion
  {
    ...
    {
      Logs.log(Logs.LogTypes.debug, " quaternion_X: " + g + " quaternion_Y: " + h + " quaternion_Z: " + i + " quaternion_W: " + j + " timestampAndFlags: " + k);
    }
  ...
  public class YetiP2P
  {
    ...
    {
      Logs.log(Logs.LogTypes.debug, " hzAngle: " + f + " veAngle: " + g + " inclinationStatus: " + h + " timestampAndFlags: " + i);
    }
  ...
  public class YetiBasicMeasurements
  {
    ...
    {
      Logs.log(Logs.LogTypes.debug, " distance: " + i + " inclination: " + j + " direction: " + k + " timestampAndFlags: " + o);
    }
