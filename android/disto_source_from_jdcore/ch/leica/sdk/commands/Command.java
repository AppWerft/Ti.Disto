...
public abstract class Command
{
  ...
  public abstract void preparePayload(Types.Commands paramCommands, List<String> paramList);
  
  public abstract void preparePayload(String paramString);
  
  public static boolean isCommandCorrect(String paramString1, String paramString2, String paramString3)
  {
    boolean bool = false;
    if ((paramString1 != null) && (paramString2 != null) && (paramString3 != null) && (((paramString1.matches("^[\\p{Alnum}|_]+$")) && (paramString2.matches("^[\\p{Alnum}|_]*$")) && (paramString3.matches("^[\\p{Alnum}|_\t]*$"))) || ("\r\n".equals(paramString1)))) {
      bool = true;
    }
    return bool;
  }
  ...
  public void setPayload(String paramString, boolean paramBoolean, List<String> paramList)
  {
    if (paramString != null)
    {
      payload = paramString;
      ...
      if (paramList != null)
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          if ((str != null) && (!str.isEmpty()) && (isParameterCorrect(str))) {
            payload = (payload + " " + str);
          }
        }
      }
      if (paramBoolean == true)
      {
        ...
        {
          Logs.log(Logs.LogTypes.codeerror, "Caused by: Terminator not Existing");
          payload = "";
        }
      }
    }
  ...
  static class a
  {
      ...
      throws IllegalArgumentCheckedException
    {
      if (paramString1 != null)
      {
        ...
        {
          Logs.log(Logs.LogTypes.debug, "Parameter1 and Parameter2 are null");
        }
      }
      else
      {
